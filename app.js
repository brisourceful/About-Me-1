...
var responseA = prompt(yesNo + askA);
...
var responseB = prompt(yesNo + askB);
...
var respnseC = prompt(yesNo + askC);
...
var responseD = prompt(yesNo + askD);
...
var responseE = prompt(yesNo + askE);
